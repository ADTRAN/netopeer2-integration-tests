...
public:
    ...
    void setActionValues(const char *xpath, std::unique_ptr<SysrepoValues> &&values);
private:
    void sysrepoConnect();
    ...
    static int actionTrampoline(const char *xpath,
                                const sr_val_t *input,
                                const size_t input_cnt,
                                sr_val_t **output,
                                size_t *output_cnt,
                                void *data);
    int handleAction(const char *xpath,
                     const sr_val_t *input,
                     const size_t input_cnt,
                     sr_val_t **output,
                     size_t *output_cnt);
    ...
    std::unordered_map<std::string, std::shared_ptr<SysrepoValues>> m_actionValues;
